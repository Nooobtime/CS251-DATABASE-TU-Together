      ...
      >
        ...
        >
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">
            กล้าเลือก กล้าใช้สิทธิ์ ไม่มีโกง300%
          </p>
          <div
...
<script setup>
const stats = [
  { id: 1, name: "ยังกับ Tesis", value: "สั่งงานก็ยาก" },
  { id: 2, name: "เดือนเดียวเอง", value: "เวลาก็น้อย" },
  { id: 3, name: "เกรด D ก็ได้", value: "ไม่ทำแล้ว" },
];
</script>
